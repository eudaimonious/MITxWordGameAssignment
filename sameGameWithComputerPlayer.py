...
def compChooseWord(hand, wordList, n):
    ...
    for word in wordList:
        ...
        if isValidWord(word, hand, wordList):
            ...
            if wordScore > maxScoreSoFar:
                # Update your best score, and best word accordingly
                maxScoreSoFar = wordScore
                bestWordSoFar = word
...
def compPlayHand(hand, wordList, n):
    ...
    if calculateHandlen(hand) == 0 or word == None:
...
def playGame(wordList):
    ...
    while i != 'e':
        ...
        if i == 'n':
            ...
            while i2 != 'u' and i2 != 'c':
                i2 = raw_input("Enter u to have yourself play, c to have the computer play: ")
                if i2 == 'u':
